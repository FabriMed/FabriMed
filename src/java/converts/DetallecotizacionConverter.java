...
import controller.DetallecotizacionFacade;
...
@FacesConverter(value = "detallecotizacionConverter")
public class DetallecotizacionConverter implements Converter {

    @Inject
    private DetallecotizacionFacade ejbFacade;
